...
require_once($phpbb_root_path.'konkurs/konkurs.inc.php');
			...
			else
			{
				foreach ($bbcode_data['regexp'] as $regexp => $replacement)
				{
					...
					if (preg_match($regexp, $this->message))
					{
						...
						if($bbcode_data["bbcode_id"]==25) {
							preg_match($regexp.'u', $this->message, $k_matches);
							$e_k = new Konkurs(mb_strtolower($k_matches[1]));
							$e_k->addNew($k_matches);
						}
